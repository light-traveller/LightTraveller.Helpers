...
public class PagingExtensionTests
{
    ...
    public void WithZeroPageSize_GetNumberOfPages_Should_Throw()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => totalRecords.GetPageCount(pageSize: 0));
    }
    ...
    {
        var totalRecords = 100L;
        _ = Assert.Throws<ArgumentException>(() => totalRecords.GetPageCount(pageSize: -5));
    }
    ...
    {
        var totalRecords = 0L;
        Assert.Equal(0, totalRecords.GetPageCount(pageSize: 5));
    }
    ...
    {
        var totalRecords = 100L;
        Assert.Equal(10, totalRecords.GetPageCount(pageSize: 10));
    }
    ...
    public void WithNonZeroRamainder_GetNumberOfPages_Should_ReturnTotalRecordsDividedByPageSizePlusOne()
    {
        ...
        Assert.Equal(11, totalRecords.GetPageCount(pageSize: 10));
    }
}
